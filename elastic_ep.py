...
def _needs_elastic_ep_state(server_args: ServerArgs) -> bool:
    if server_args.elastic_ep_backend is not None:
        return True
    from sglang.srt.layers.moe import get_moe_a2a_backend

    return get_moe_a2a_backend().is_mooncake() or get_moe_a2a_backend().is_nixl()
...
class ElasticEPStateManager:
    ...
    def init(cls, server_args: ServerArgs):
        ...
        if _needs_elastic_ep_state(server_args):
