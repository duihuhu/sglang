...
from sglang.srt.elastic_ep.elastic_ep import ElasticEPStateManager, _needs_elastic_ep_state
...
class ModelRunner(ModelRunnerKVCacheMixin):
    ...
    def initialize(self, pre_model_load_memory: float):
        ...
        (
            ...
            if _needs_elastic_ep_state(self.server_args)
            else None
        )
        # Load the model
    ...
    def load_model(self):
        ...
        if getattr(self, "_skip_load_model_barrier_once", False):
            ...
            if self.server_args.elastic_ep_backend == "mooncake" or get_moe_a2a_backend().is_mooncake():
