#!/usr/bin/env python3
"""Controlled EP4 scan of equal load over 4/3/2/1 active ranks."""
...
def worker(sa,pa,a,gpu,rank):
 ...
 try:
  ...
  for M in a.tokens:
   ...
   for active in order:
    layer.mlp._forced_active_rank_count=active;old=forced_routing(layer.mlp,'active_ranks_equal',4)
