...
MODES=('hot_rank_0250','hot_rank_0500','hot_rank_0750','hot_rank_0875','hot_rank_1000')
...
def main():
 ...
 s=HotScheduler(a,nodes,jobs);rc=s.run();s.export_compat();return rc
